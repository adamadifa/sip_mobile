...
<div class="loading"><div class="spinner-border text-primary" role="status"></div></div>
  <!-- loader -->
    ...
    if (isset($_COOKIE['COOKIES_MEMBER'])) {
        echo '
<!-- App Header -->
    <div class="appHeader text-light" style="background-color:#065606">
        <div class="left">
        ...
        if ($row_user['foto'] == '') {
            ...
            echo '
                <img src="' . $site_url . '/content/karyawan/' . $row_user['foto'] . '" alt="image" class="imaged w40">';
        }
        echo '
    ...
    <div class="modal fade panelbox panelbox-left" id="sidebarPanel" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body p-0" style="background-color:#F6B310 ">
                    <!-- profile box -->
        ...
        if ($row_user['foto'] == '') {
            ...
            echo '<img src="' . $site_url . '/content/karyawan/' . $row_user['foto'] . '" class="imaged w36">';
        }
        echo '
                        </div>
                        <div class="in">
                    ...
                    <ul class="listview flush transparent no-line image-listview">
                        <li>
                            <a href="./" class="item">
                                <div class="icon-box"  style="color:black; font-size:18px;">
                                    <ion-icon name="home-outline"></ion-icon>
                                </div> Home 
                            </a>
                        </li>
                        <li>
                            <a href="./checklist-ibadah" class="item">
                                <div class="icon-box"  style="color:black; font-size:18px;">
                                <ion-icon name="checkbox-outline"></ion-icon>
                                </div> Checklist Ibadah 
                            </a>
                        </li>
                       
                        <li>
                            <a href="./logout" class="item">
                                <div class="icon-box" style="background-color:#065606; color:white">
