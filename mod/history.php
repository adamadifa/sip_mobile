    ...
    <div class="card-body">
            ...
            <div class="form-group basic">
                <div class="input-wrapper">
                    <div class="input-group">
                        <input type="text" class="form-control datepicker start_date" name="start_date" autocomplete="off" placeholder="Tanggal Awal" required>
        ...
        <div class="col-sm-4  col-md-4">
            <div class="form-group basic">
                <div class="input-wrapper">
                    <div class="input-group">
                        <input type="text" name="end_date" class="form-control datepicker end_date" autocomplete="off" value="' . tanggal_ind($date) . '">
                        <div class="input-group-addon">
                            <ion-icon name="calendar-outline"></ion-icon>
                        </div>
                    </div>
        ...
        <div class="col-sm-4 col-md-4 justify-content-between">
           <button type="button" class="btn btn-primary mt-1 btn-sortir"><ion-icon name="tv-outline"></ion-icon></button>
           ...
           <button type="button" class="btn btn-success mt-1 btn-clear"><ion-icon name="repeat-outline"></ion-icon></button>
        </div>
