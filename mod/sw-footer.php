...
<script src="' . $base_url . '/mod/assets/js/sw-script.js"></script>';
    ...
    <?php } else  if ($mod == 'checklist-ibadah') { ?>
        <script>
            $(function() {
                function loadchecklistibadah() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: './sw-proses?action=load-kegiatan',
                        data: {
                            tanggal: tanggal
                        },
                        cache: false,
                ...
                $('.btn-print-checklistibadah').click(function(e) {
                    var bulan = $('.bulan').val();
                    var tahun = $('.tahun').val();
                    var url = "./print-checklistibadah?action=pdf&bulan=" + bulan + "&tahun=" + tahun + "";
                ...
                $(document).on('click', '.checklist', function() {
                    ...
                    if ($(this).prop("checked") == true) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: './sw-proses?action=simpanchecklist',
                            data: {
                                tanggal: tanggal,
                                id: id
                            },
                        ...
                        $.ajax({
                            type: 'POST',
                            url: './sw-proses?action=hapuschecklist',
                            data: {
                                tanggal: tanggal,
                                id: id
                            },
